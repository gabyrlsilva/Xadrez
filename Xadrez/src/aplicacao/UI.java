...
public class UI {
	...
	public static XadrezPosicao leiaPosicaoXadrez(Scanner sc) {
		try {
	...
	public static void printPartida(XadrezPartida xadrezPartida, List<XadrezPeca> captura) {
		printTabuleiro(xadrezPartida.getPecas());
		System.out.println();
		printPecaCapturada(captura);
		System.out.println();
		System.out.println("Turn : " + xadrezPartida.getTurn());
		if (!xadrezPartida.getCheckMate()) {
			System.out.println("Waiting player: " + xadrezPartida.getJogadorAtual());
			...
			System.out.println("Winner: " + xadrezPartida.getJogadorAtual());
		}
	}
	...
	public static void printTabuleiro(XadrezPeca[][] pecas, boolean[][] possivelMovimentos) {
		for (int i = 0; i < pecas.length; i++) {
			System.out.print((8 - i) + " ");
			for (int j = 0; j < pecas.length; j++) {
